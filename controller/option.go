...
func UpdateOption(c *gin.Context) {
	...
	switch option.Key {
	case "RegistrationVerificationMode":
		mode := option.Value.(string)
		if (mode == "phone" || mode == "email_or_phone") && !service.SMSRegistrationReady() {
	...
	case "ModelUserGroupRatio":
		err = ratio_setting.CheckModelUserGroupRatio(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
